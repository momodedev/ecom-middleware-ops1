...
resource_group_name      = "kafka-perf-v5-centos"             # control node resources will live in this RG (existing)
resource_group_location = "westus3"
use_existing_control_network             = true
control_nsg_id                          = "/subscriptions/8d6bd1eb-ae31-4f2c-856a-0f8e47115c4b/resourceGroups/kafka-perf-v5-centos/providers/Microsoft.Network/networkSecurityGroups/rds-prod-nsg"                   # use existing NSG for control node
